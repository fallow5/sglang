...
class RuntimeContext:
    ...
    def resolved_server_args_dict(self, base: dict | None = None) -> dict:
        ...
        Every post-publish change is in this one log, including the ones the
        bags do not model as leaves (the model path and served name stay
        manager attributes). ``/server_info`` does not use this dump: it
